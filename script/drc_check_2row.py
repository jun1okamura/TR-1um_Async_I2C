...
DRC check on the 2-row routed GDS -- same rule set as drc_check_full.py
(M1/M2 width+space, V1 space, V1-M1/M2 enclosure, V1-GC separation).
"""
import sys
import klayout.db as db

GDS = sys.argv[1] if len(sys.argv) > 1 else \
    "/sessions/dreamy-ecstatic-heisenberg/mnt/TR-1um_Async_I2C/Layout/i2c_slave_async_2row_routed.gds"
TOP_CELL = "i2c_slave_async_2row"
