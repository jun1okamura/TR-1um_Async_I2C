...
GDS = sys.argv[1] if len(sys.argv) > 1 else "/sessions/dreamy-ecstatic-heisenberg/mnt/TR-1um_Async_I2C/Layout/i2c_slave_async_layout_routed_pilot.gds"
layout = db.Layout()
layout.read(GDS)
dbu = layout.dbu
top = layout.cell("i2c_slave_async_layout")

def idx(l): return layout.layer(*l)
