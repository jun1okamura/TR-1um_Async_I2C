...
C {MP.sym} 140 -330 1 0 {name=M7 model=PMOS w=21.2u l=8.6u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 140 -210 1 0 {name=M2 model=NMOS w=13.1u l=8.6u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
